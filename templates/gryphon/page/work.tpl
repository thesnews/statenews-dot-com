...
<div class="grid_8">
	...
	<div class="grid_4 alpha">
		...
		<p>
			The State News is accepting applications for <strong>writers</strong> for the <strong>newsroom</strong>. Please send samples and a resume to <a href="mailto:editorinchief@statenews.com">editorinchief@statenews.com</a>.
		</p>

		<hr />

		<p>
			The State News is accepting applications for <strong>copy editors</strong> for the <strong>newsroom</strong>. Please send samples and a resume to <a href="mailto:editorinchief@statenews.com">editorinchief@statenews.com</a>.
		</p>

		<hr />

		<p>
			The State News is accepting applications for <strong>graphic designers</strong> for the <strong>web</strong> department. No HTML experience necessary. Send samples and resume to <a href="mailto:webmaster@statenews.com">webmaster@statenews.com</a>
		</p>

		<hr />

		<p>
			The State News is accepting applications for <strong>photographers</strong>. Send samples and resume to <a href="mailto:photo@statenews.com">photo@statenews.com</a>
		</p>
