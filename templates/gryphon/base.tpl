...
<head>
	...
	<meta name="readability-verification" content="XQYpXryxDN8bKfYaReH2r35eVuYuVBkb4xXudJDw"/>
	...
	<script type="text/javascript" src="{{ 'javascript/vendor/mootools/mootools-1.2.5-compressed.js'|asset }}"></script>
	...
	{% if config.get('debug') %}
		<script type="text/javascript" src="{{ 'javascript/vendor/offspring.js'|asset }}"></script>
		<script type="text/javascript" src="{{ 'javascript/vendor/rosewood.js'|asset }}"></script>
		<script type="text/javascript" src="{{ 'javascript/base.js'|asset }}"></script>
		<script type="text/javascript" src="{{ 'javascript/expandable.js'|asset }}"></script>

		<script src="{{ 'javascript/vendor/video-js/video.js'|asset }}" type="text/javascript" charset="utf-8"></script>
	{% else %}
		<script src="{{ 'javascript/snews.compressed.js'|asset }}" type="text/javascript"></script>
	{% endif %}
	...
	<link rel="icon" type="image/png" href="{{ 'style/gryphon/images/favico.png'|asset }}" />
	<link rel="stylesheet" type="text/css" media="screen, projection" href="{{ 'style/gryphon/screen/master.css'|asset }}" />
	<link rel="stylesheet" type="text/css" media="print" href="{{ 'style/gryphon/print/master.css'|asset }}" />
	<!--[if IE 6]>
		<link rel="stylesheet" type="text/css" media="screen, projection" href="{{ 'style/screen/ie6.css'|asset }}" />
	<![endif]-->
	<link rel="stylesheet" href="{{ 'javascript/vendor/video-js/video-js.css'|asset }}" type="text/css" media="screen" title="Video JS" charset="utf-8">
...
<body>
	...
	<div id="wrapper"> <!-- CENTERS EVERYTHING -->
		<div id="ticker">
			...
			<span id="links"><a href="http://advertise.statenews.com">Advertise</a> | <a href="{{ 'classifieds'|url }}">Classifieds</a> | <a href="{{ 'page/puzzles'|url }}">Puzzles</a> | <a href="{{ 'page/work'|url }}">Employment</a> | <a href="{{ 'page/contact'|url }}">Contact Us</a> | <a href="{{ 'page/subscriptions'|url }}">Subscriptions</a></span>
		</div>
			...
			<div class="container_12" id="main-content"> <!-- 960.GS STARTS HERE. DONT FORGET TO USE "CLEAR" DIVs AFTER EACH ROW! -->
				...
				<div class="grid_12">
					<div class="advertisement leaderboard">
						...
						<iframe id='a36d3014' name='a36d3014' src='http://ads.thesn.net/openx/www/delivery/afr.php?n=a36d3014&amp;zoneid=7&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;ct0=INSERT_CLICKURL_HERE' frameborder='0' scrolling='no' width='728' height='90' allowtransparency='true'><a href='http://ads.thesn.net/openx/www/delivery/ck.php?n=ac03f61a&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://ads.thesn.net/openx/www/delivery/avw.php?zoneid=7&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=ac03f61a&amp;ct0=INSERT_CLICKURL_HERE' border='0' alt='' /></a></iframe>
