...
{% if developing or breaking %}
<div class="grid_12">
	{% if developing %}
		<div class="developing-box">
			<h3>
				<a href="{{ developing.url }}"{% if developing.headline|length > 70 %} style="height: 70px;"{% endif %}>{{ developing.headline }}</a>
				<span>Last updated {{ developing.modified|timeSince }}</span`>
			</h3>
		</div>
	...
	{% if breaking %}
		<div class="breaking-box"{% if breaking.headline|length > 70 %} style="height: 70px;"{% endif %}>
			<h3>
				<a href="{{ breaking.url }}">{{ breaking.headline }}</a>
				<span>Last updated {{ breaking.modified|timeSince }}</span>
			</h3>
		</div>
...
<div class="grid_8">
	...
	<div class="grid_3 alpha">
		<!-- prod notice
		<div class="box gray">
			The State News will resume regular publication May 14, 2012. Until then, check statenews.com and follow <a href="http://twitter.com/thesnews">@thesnews</a> on Twitter for breaking news updates.
		</div>
		<hr class="spacer" />
		end prod notice -->
		...
		<a href="{{ 'page/bestof'|url }}">
			<img src="{{ 'images/bestof/bestof-fp-post.png'|url }}" style="border: none;"/>
		</a>
		<hr class="spacer" />
